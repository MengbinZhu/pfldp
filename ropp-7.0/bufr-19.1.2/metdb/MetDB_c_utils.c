 ...
 *          metdb_cread      - read char data
 *          metdb_cwrite     - write char data
 ...
 *
 * $Revision: 2$
 * $Date: 16/02/2012 11:40:13$
 * $Source: /home/us0400/mdb/op/lib/source/RCS/MetDB_c_utils.c,v $
 *
 * $Log:
 *  2    Met_DB_Project 1.1         16/02/2012 11:40:13    Sheila Needham
 *       Added string.h to stop warning errors
 ...
 *                           -3 = unit out of range
 *
 *     ignore  len_dataset : not passed by calling program. Used
