! $Id: ropp_1dvar_bangle.f90 3551 2013-02-25 09:51:28Z idculv $

PROGRAM ropp_1dvar_bangle

!****p* Programs/ropp_1dvar_bangle *
!
! NAME
!    ropp_1dvar_bangle
!
...
!-------------------------------------------------------------------------------
  ...
  CALL message_set_routine('ropp_1dvar_bangle')
...
!          ----------------------------------------------------
           ...
           CALL ropp_io_free(res_data%lev2a)
...
!-------------------------------------------------------------------------------
  ...
  SUBROUTINE usage()
    PRINT *, 'Purpose:'
    PRINT *, '  Bending Angle 1D-Var retrieval'
    PRINT *, 'Usage:'
    PRINT *, '  > ropp_1dvar_bangle [<options>]'
    PRINT *, 'Options:'
