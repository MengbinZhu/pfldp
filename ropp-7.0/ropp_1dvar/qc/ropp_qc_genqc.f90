! $Id: ropp_qc_genqc.f90 3551 2013-02-25 09:51:28Z idculv $
...
! 1.4.1 Valid bending angle values
  ...
  idx => WHERE(obs%bangle > -900.0_wp .AND. obs%weights > 0.0_wp, cnt)
...
! 2.4.1 Valid refractivity values
  ...
  idx => WHERE(obs%refrac > -900.0_wp .AND. obs%weights > 0.0_wp, cnt)
