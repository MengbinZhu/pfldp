! $Id: ropp_fm_obs2roprof.f90 3551 2013-02-25 09:51:28Z idculv $

!****s* Copying/ropp_fm_obs2roprof *
!
! NAME
...
! -------------
  ...
  CALL ropp_io_init(ro_data%Lev1b, SIZE(y%bangle))
...
! -------------
  ...
  CALL ropp_io_init(ro_data%Lev2a, SIZE(y%refrac))
