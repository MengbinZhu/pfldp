! $Id: ropp_fm_refrac_1d_ad.f90 3551 2013-02-25 09:51:28Z idculv $
...
!-------------------------------------------------------------------------------
! 4. Adjoint of forward model calculations
!-------------------------------------------------------------------------------

! 4.1 Adjoint interpolation to measurement's geopotential levels

  CALL ropp_fm_interpol_log_ad(z_geop,y%geop,refrac,z_geop_ad, refrac_ad,y_ad)

! 4.2 Adjoint of refractivity calculation
...
! 4.3 Adjoint of water vapor pressure calculation
