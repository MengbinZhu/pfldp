! $Id: ropp_fm_bangle_1d_tl.f90 3831 2013-08-27 15:22:48Z idculv $
...
!-------------------------------------------------------------------------------
! 6. Calculate bending angle
!-------------------------------------------------------------------------------

  CALL ropp_fm_abel_tl(impact, refrac, y%impact, impact_tl, refrac_tl, y_tl)
