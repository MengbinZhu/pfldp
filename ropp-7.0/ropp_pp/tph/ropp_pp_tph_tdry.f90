...
! 2.5 Calculate dry pressure pdry = N Tdry / kappa1
! -------------------------------------------------

    CALL calc_pdry(ro_data%lev2a%refrac, lregion, var_x, var_y, var_p)  ! = N*Tdry/kappa1, if possible; otherwise estimated from Tdry profile
