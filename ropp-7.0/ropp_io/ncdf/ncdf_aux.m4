...
define(`NCDF_SFUN',`ncdf_'PUTORGET`var_'KINDVALUE)
define(`NCDF_SFUNATT',`ncdf_'PUTORGET`att_'KINDVALUE)
ifelse(POINTER,`yes',
            `define(`NCDF_AFUN',`ncdf_'PUTORGET`val_'ND_KINDVALUE)',
            `define(`NCDF_AFUN',`ncdf_'PUTORGET`var_'ND_KINDVALUE)')
ifelse(POINTER,`yes',
            `define(`NCDF_AFUNATT',`ncdf_'PUTORGET`atl_'ND_KINDVALUE)',
            `define(`NCDF_AFUNATT',`ncdf_'PUTORGET`att_'ND_KINDVALUE)')
define(`UT_SFUN',`utconverts_'KINDVALUE)
ifelse(POINTER,`yes',
            `define(`UT_AFUN',`utconvertp_'ND_KINDVALUE)',
            `define(`UT_AFUN',`utconverta_'ND_KINDVALUE)')
define(`NCDF_ASAV',`ncdf_save_'ND_KINDVALUE)
define(`NCDF_SSAV',`ncdf_save_'KINDVALUE)
define(`NCDF_AFUN_NAMED',`ncdf_'PUTORGET`var_'ND_KINDVALUE`_named')
define(`NCDF_AFUN_NCID',`ncdf_'PUTORGET`var_'ND_KINDVALUE`_ncid')
define(`NCDF_AFUN_CURRENT',`ncdf_'PUTORGET`var_'ND_KINDVALUE`_current')
